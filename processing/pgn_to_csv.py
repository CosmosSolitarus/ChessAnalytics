...
def pgn_to_csv(username):
    ...
    with open(f"pgn/MyGames{username}.pgn") as pgn_file:
        ...
        with open(f"csv/MyGames{username}.csv", mode="w", newline="") as csv_file:
            ...
            with open(f"csv/Moves{username}.csv", mode="w", newline="") as moves_file:
                ...
                while True:
                    ...
                    if (game.headers.get("TimeControl") == "600" and not isFriendlyMatch(game.headers.get("White"), game.headers.get("Black"))):
                        ...
                        my_elo = headers.get("WhiteElo") if white_player == username else headers.get("BlackElo")
                        opp_elo = headers.get("BlackElo") if white_player == username else headers.get("WhiteElo")
