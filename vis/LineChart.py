...
def create_elo_progression_chart(csv_file='csv/MyGamesCombined.csv', mode='default'):
    ...
    mode : str
        ...
        'modern': Shows games from and after the one with Elo 1575 on Nov 3, 2024 with 10% max decrease.
        'recent': Shows games from and after the one with Elo 1807 on Jan 24, 2025 with 10% max decrease.
    ...
    if mode == 'default':
        # Default mode: all 10-minute games from May 31, 2024 onward
        filtered_data = df[
